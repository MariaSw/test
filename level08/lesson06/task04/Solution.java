...
public class Solution
{
    ...
    {
        System.out.println(getTimeMsOfGet(fill(new ArrayList())));//2 - обращается к ячейке сразу
        System.out.println(getTimeMsOfGet(fill(new LinkedList())));//12 - ему нужно пройти от начала списка до нужного элемнта
    }
